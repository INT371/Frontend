...
<div class=" bg-white rounded-lg border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700">
    ...
    <div class="p-5 ">
        ...
        <p class="mb-3 font-normal text-gray-700 dark:text-gray-400">{{policy}}</p>
        <p class="mb-3 font-normal text-gray-700 dark:text-gray-400">{{type_name}}</p>
        <p class="mb-3 font-normal text-gray-700 dark:text-gray-400">{{max_capacity}}</p>

        <router-link :to=" {name: 'singleRoom', params: { singleRoom: roomId} } ">
