...
<div class=" bg-white rounded-lg border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700">
    ...
    <div class="p-5 ">
        <a href="#">
            <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">{{type_name}}</h5>
        </a>
        <p class="mb-3 font-normal text-gray-700 dark:text-gray-400">{{description}}</p>
        <p class="mb-3 font-normal text-gray-700 dark:text-gray-400">Price : {{price}}</p>
        <p class="mb-3 font-normal text-gray-700 dark:text-gray-400">Policy : {{policy}}</p>
        <p class="mb-3 font-normal text-gray-700 dark:text-gray-400">Capacity : {{max_capacity}}</p>

        <router-link :to=" {name: 'singleRoom', params: { singleRoom: type_id} } ">
